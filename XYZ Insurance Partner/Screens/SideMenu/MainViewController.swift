...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 101:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "UnassignedLeadsNavID")
         
        case 102:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "LeadsNavID")
            
        case 103:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "IssuedPoliciesNavID")
            
        case 104:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "IssuedPoliciesNavID")
            
        case 105:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "DueActionsNavID")
        ...
        case 107:
            self.showViewController(viewController: UINavigationController.self, storyboardId: "CustomersNavID")
